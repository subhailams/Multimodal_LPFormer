...
def main():
    ...
    parser.add_argument('--save-as', type=str, default="pinterest_clip_multimodal_6k_new")
    ...
    parser.add_argument("--checkpoint", type=str, default="pinterest_clip_multimodal_6k_new")
...
# python src/run.py --data_name pinterest --dataset_path /home/silama3/subha/graph/dataset --lr 5e-3  --gnn-layers 1 --dim 128  --batch-size 4086  --epochs 10 --eps 1e-7 --gnn-drop 0.1 --dropout 0.1 --pred-drop 0.1 --att-drop 0.1 --num-heads 1  --thresh-1hop 1e-2 --thresh-non1hop 1e-2  --feat-drop 0.1 --l2 0 --eval_steps 1 --decay 0.975  --runs 1 --non-verbose --device 0


# python src/run.py --data_name pinterest --dataset_path /home/silama3/subha/graph/data_processed_clip_blip_100k --lr 5e-3  --gnn-layers 1 --dim 128  --batch-size 4086  --epochs 10000 --eps 1e-7 --gnn-drop 0.1 --dropout 0.1 --pred-drop 0.1 --att-drop 0.1 --num-heads 1  --thresh-1hop 1e-2 --thresh-non1hop 1e-2  --feat-drop 0.1 --l2 0 --eval_steps 1 --decay 0.975  --runs 1 --non-verbose --device 0


# python src/run.py --data_name pinterest --dataset_path /home/silama3/subha/graph/data_processed_clip_blip_100k --lr 5e-3  --gnn-layers 2 --dim 128  --batch-size 1024  --epochs 2000 --eps 1e-7 --gnn-drop 0.1 --dropout 0.1 --pred-drop 0.1 --att-drop 0.1 --num-heads 1  --thresh-1hop 1e-2 --thresh-non1hop 1e-2  --feat-drop 0.1 --l2 0 --eval_steps 1 --decay 0.975  --runs 1 --non-verbose --device 0 --checkpoint pinterest_clip_only_06_dec_bs_1024
