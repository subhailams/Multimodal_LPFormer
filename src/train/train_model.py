...
def train_epoch(model, score_func, data, optimizer, args, device, losses):
    model.train()
    score_func.train()
    ...
    losses.append(avg_loss)  # Append the loss for this epoch
    # print(f"Epoch {epoch}, Loss: {avg_loss}")
    return avg_loss


def plot_loss_vs_epoch(epochs, losses, output_file="loss_vs_epoch.png"):
    ...
    print(f"Loss vs Epoch plot saved as {output_file}")
...
def train_loop(args, train_args, data, device, loggers, seed, model_save_name, verbose):
    ...
    for epoch in range(1, 1 + args.epochs):
        ...
        epochs.append(epoch)
        loss = train_epoch(model, score_func, data, optimizer, args, device, losses)
    ...
    plot_loss_vs_epoch(epochs, losses, output_file="loss_vs_epoch.png")
