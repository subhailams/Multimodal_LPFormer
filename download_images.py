...
def download_image(task_queue, progress_bar):
    ...
    while not task_queue.empty():
        ...
        try:
            ...
            with open(f'/data/silama3/pinterest_images/{img_id}.jpg', 'wb') as img_file:
...
if __name__ == "__main__":
    ...
    filepath = 'dataset/users_to_images.train'
    if not os.path.exists("/data/silama3/pinterest_images"):
        os.makedirs("/data/silama3/pinterest_images")
